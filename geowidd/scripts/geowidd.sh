...
serviceNameLo="geowidd"                                     # service name with the first letter in lowercase
serviceName="GeowidD"                                       # service name
serviceUser="vio"                                           # OS user name for the service
...
javaArgs="-jar $applDir/lib/$serviceNameLo.jar etc/geowid_daemon_settings.xml" # arguments for Java launcher
